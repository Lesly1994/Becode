...
- avec la propriété `style` ajouter un `border-top` de `3px solid red` (n'oublie pas que tu peux acceder aux propriétés d'un objet grâce à ceci : ["prop-name"] )
...
## EXERCICE 4 bis : Création et suppression de plusieurs éléments
